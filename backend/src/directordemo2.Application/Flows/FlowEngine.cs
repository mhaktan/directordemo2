                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = System.Type.GetType("directordemo2.Approvals.IApprovalAppService, directordemo2.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in directordemo2.Application assembly");
                            ...
                            var submitInputType = System.Type.GetType("directordemo2.Approvals.Dto.SubmitApprovalInput, directordemo2.Application")!;
