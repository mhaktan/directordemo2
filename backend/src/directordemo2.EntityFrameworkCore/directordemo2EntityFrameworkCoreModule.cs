...
{
    [DependsOn(typeof(directordemo2CoreModule), typeof(AbpEntityFrameworkCoreModule))]
    public class directordemo2EntityFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpEfCore().AddDbContext<directordemo2DbContext>(options =>
            {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(directordemo2EntityFrameworkCoreModule).GetAssembly());
        }
    }
}
