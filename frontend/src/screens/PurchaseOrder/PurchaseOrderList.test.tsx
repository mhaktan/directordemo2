...
describe('PurchaseOrderList', () => {
  it('should render without crashing', () => {
    const { container } = render(<PurchaseOrderList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<PurchaseOrderList />, { wrapper });
    expect(screen.getByText('PurchaseOrder')).toBeDefined();
  });

  it('should have create button', () => {
    render(<PurchaseOrderList />, { wrapper });
    expect(screen.getByText('+ Create PurchaseOrder')).toBeDefined();
  });
