...
describe('ExpenseCategoryList', () => {
  it('should render without crashing', () => {
    const { container } = render(<ExpenseCategoryList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<ExpenseCategoryList />, { wrapper });
    expect(screen.getByText('ExpenseCategory')).toBeDefined();
  });

  it('should have create button', () => {
    render(<ExpenseCategoryList />, { wrapper });
    expect(screen.getByText('+ Create ExpenseCategory')).toBeDefined();
  });
