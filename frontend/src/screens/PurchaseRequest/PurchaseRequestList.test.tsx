...
describe('PurchaseRequestList', () => {
  it('should render without crashing', () => {
    const { container } = render(<PurchaseRequestList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<PurchaseRequestList />, { wrapper });
    expect(screen.getByText('PurchaseRequest')).toBeDefined();
  });

  it('should have create button', () => {
    render(<PurchaseRequestList />, { wrapper });
    expect(screen.getByText('+ Create PurchaseRequest')).toBeDefined();
  });
