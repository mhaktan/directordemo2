...
describe('PurchaseRequestItemList', () => {
  it('should render without crashing', () => {
    const { container } = render(<PurchaseRequestItemList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<PurchaseRequestItemList />, { wrapper });
    expect(screen.getByText('PurchaseRequestItem')).toBeDefined();
  });

  it('should have create button', () => {
    render(<PurchaseRequestItemList />, { wrapper });
    expect(screen.getByText('+ Create PurchaseRequestItem')).toBeDefined();
  });
